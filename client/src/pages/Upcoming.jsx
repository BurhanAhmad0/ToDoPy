    ...
    <section className="tasks h-full py-14 px-3 lg:p-6 bg-sidebar-background dark:bg-green-900 text-black dark:text-white lg:rounded-4xl p-6 transition-all duration-300">
          ...
          <div className="taskInput relative">
            <div className="flex items-center justify-between px-2 py-2 mt-3 border border-black dark:border-white rounded-lg w-full bg-white dark:bg-green-800">
              ...
              <button
                ...
                className="bg-btn text-white px-10 py-2 rounded-sm cursor-pointer hover:bg-btn/60 transition-all duration-300"
              >
                Save
              </button>
            </div>
              ...
              >
                ...
                <div className="btns flex items-center gap-1">
                  <button
                    ...
                    className="bg-btn px-10 py-2 rounded-sm text-black hover:bg-btn/60 transition-all duration-300 hidden sm:block"
                  >
                    Edit
                  </button>
                  <button
      ...
      <div className="lowerDiv flex flex-col sm:flex-row gap-4">
        {[{ label: "Tommorow" }, { label: "This Week" }].map((section, idx) => (
          <div
            key={idx}
            className="tasks rounded-4xl border border-black dark:border-white mt-5 p-6 h-80 sm:w-1/2 transition-all duration-300"
          >
            ...
            <div className="taskList mt-5 h-4/5 overflow-y-auto">
              {Todos.length < 1 ? (
                ...
                Todos.map((todo) => (
                  <div
                    key={todo._id}
                    className="task flex items-center gap-5 h-12 border-b border-black dark:border-white"
                  >
                    <input
                      type="checkbox"
                      id={`todo-${todo._id}`}
