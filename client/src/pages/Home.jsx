...
const Home = () => {
    ...
    return (
        <section className='home bg-sidebar-background dark:bg-green-900 text-black dark:text-white w-full h-full xsm:h-screen lg:h-full rounded-4xl flex flex-col items-center justify-center py-10 px-10 lg:px-28 transition-all duration-300'>
